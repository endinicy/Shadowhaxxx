/**************************************************************************/
/*!
    @file     EQMon_ADS1015.h
              Changed name from Adafruit_ADS1015.h
    ...
    v1.2  - Updated by LB for ADS1115 only
    Same as ADS1015 except for Sample Rate
    Cleaned up the code to handle only ADS1115 - 16 bit chipset
    Added methods:
    startContinuousADC_Differential_0_1(void)  -- Start the ADC in continuous mode
    getLow(void)                               -- Read the low Threshold register
   getHigh(void)                               -- Read the high threshold register
*/
/**************************************************************************/
...
/*=========================================================================
    ...
    -----------------------------------------------------------------------*/
    #define ADS1115_CONVERSIONDELAY_8           (125000)       // Not Reliable
    #define ADS1115_CONVERSIONDELAY_16          (62500)        // Not Reliable
    #define ADS1115_CONVERSIONDELAY_32          (31250)        // Not Reliable
    #define ADS1115_CONVERSIONDELAY_64          (15626)        // Delay for 64 SPS
    #define ADS1115_CONVERSIONDELAY_128         (7813)         // Delay for 128 SPS
    #define ADS1115_CONVERSIONDELAY_250         (4000)         // Delay for 250 SPS
    #define ADS1115_CONVERSIONDELAY_475         (2106)         // Delay for 475 SPS
    #define ADS1115_CONVERSIONDELAY_860         (1163)         // Delay for 860 SPS
/*=========================================================================*/
